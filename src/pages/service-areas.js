                ...
                <div className="container w-full px-8 mx-auto 2xl:px-0 xl:px-4">
                    ...
                    <div className="mt-40 md:mt-48">
                        <div className="flex flex-col flex-wrap items-center justify-center md:flex-row xl:justify-between">
                            <Link to="/service-areas/san-diego-county/escondido/" className="px-2 mt-16 sm:flex sm:items-center sm:justify-center md:mt-0 xl:w-1/3 sm:w-1/2">
                            ...
                            <Link to="/service-areas/san-diego-county/oceanside/" className="px-2 mt-48 sm:flex sm:items-center sm:justify-center md:mt-0 xl:w-1/3 sm:w-1/2 xl:-mb-48">
                                <div className="relative flex items-center justify-center h-full px-5 pb-32 bg-logo-blue-500 xl:w-full">
                            ...
                            <Link to="/service-areas/san-diego-county/poway/" className="px-2 mt-48 sm:flex sm:items-center sm:justify-center xl:mt-0 lg:mt-48 xl:w-1/3 sm:w-1/2">
                            ...
                            <div className="mt-48 ">
                                <div className="flex flex-col flex-wrap items-center justify-center md:flex-row xl:justify-between">
                                <Link to="/service-areas/san-diego-county/san-diego/" className="px-2 mt-16 sm:flex sm:items-center sm:justify-center md:mt-0 xl:w-1/3 sm:w-1/2">
                                        <div className="relative flex items-center justify-center h-full px-5 pb-32 bg-logo-blue-500 xl:w-full">
                                    ...
                                    <Link to="/service-areas/san-diego-county/san-marcos/" className="px-2 mt-48 sm:flex sm:items-center sm:justify-center xl:mt-0 lg:mt-48 xl:w-1/3 sm:w-1/2">
                                        <div className="relative flex items-center justify-center h-full px-5 pb-32 bg-logo-blue-500">
                                    ...
                                    <Link to="/service-areas/san-diego-county/vista/" className="px-2 mt-48 sm:flex sm:items-center sm:justify-center md:mt-0 xl:w-1/3 sm:w-1/2 xl:-mb-48">
                                        <div className="relative flex items-center justify-center h-full px-5 pb-32 bg-logo-blue-500 xl:w-full">
