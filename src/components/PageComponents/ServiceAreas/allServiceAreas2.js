                   ...
                   {/*} <div className="flex items-center justify-between">
                    ...
                    <div className="mt-40 md:mt-48">
                        <div className="flex flex-col flex-wrap items-center justify-center md:flex-row xl:justify-between">
                            <Link to="/san-diego-county/escondido" className="px-2 mt-16 group sm:flex sm:items-center sm:justify-center md:mt-0 xl:w-1/3 sm:w-1/2">
                                <div className="relative flex items-center justify-center h-full px-5 pb-32 bg-logo-blue-500 xl:w-full">
                                    <img className="object-cover object-center w-full -mt-32 transition duration-200 group-hover:scale-110" src="https://cdn.tuk.dev/assets/templates/reels/building-1.png" />
                            ...
                            <Link to="/san-diego-county/oceanside" className="px-2 mt-48 group sm:flex sm:items-center sm:justify-center md:mt-0 xl:w-1/3 sm:w-1/2 xl:-mb-48">
                                <div className="relative flex items-center justify-center h-full px-5 pb-32 bg-logo-blue-500 xl:w-full">
                                    <img className="object-cover object-center w-full -mt-32 transition duration-200 group-hover:scale-110" src="https://cdn.tuk.dev/assets/templates/reels/building-2.png" />
                                    <div className="absolute bottom-0 left-0 flex items-center mb-12 ml-7">
                                        <hr className="w-16 bg-white border-2 border-white" />
                            ...
                            <Link to="/san-diego-county/poway"  className="px-2 mt-48 group sm:flex sm:items-center sm:justify-center xl:mt-0 lg:mt-48 xl:w-1/3 sm:w-1/2">
                                <div className="relative flex items-center justify-center h-full px-5 pb-32 bg-logo-blue-500">
                                    <img className="object-cover object-center w-full -mt-32 transition duration-200 group-hover:scale-110" src="https://cdn.tuk.dev/assets/templates/reels/building-3.png" />
                                    <div className="absolute bottom-0 left-0 flex items-center mb-12 ml-7">
                                        <hr className="w-16 bg-white border-2 border-white" />
                        ...
                        <div className="mt-48 ">
                            <div className="flex flex-col flex-wrap items-center justify-center md:flex-row xl:justify-between">
                                <Link to="/san-diego-county/rancho-bernardo"   className="px-2 mt-16 group sm:flex sm:items-center sm:justify-center md:mt-0 xl:w-1/3 sm:w-1/2">
                                    <div className="relative flex items-center justify-center h-full px-5 pb-32 bg-logo-blue-500 xl:w-full">
                                ...
                                <Link to="/san-diego-county/san-diego"    className="px-2 mt-48 group sm:flex sm:items-center sm:justify-center md:mt-0 xl:w-1/3 sm:w-1/2 xl:-mb-48">
                                    <div className="relative flex items-center justify-center h-full px-5 pb-32 bg-logo-blue-500 xl:w-full">
                                ...
                                <Link to="/san-diego-county/san-marcos"  className="px-2 mt-48 group sm:flex sm:items-center sm:justify-center xl:mt-0 lg:mt-48 xl:w-1/3 sm:w-1/2">
                                    <div className="relative flex items-center justify-center h-full px-5 pb-32 bg-logo-blue-500">
                    ...
                    <div className="mt-40 md:mt-48">
                        <div className="flex flex-col flex-wrap items-center justify-center md:flex-row xl:justify-between">
                            <Link to="/san-diego-county/vista"   className="px-2 mt-16 group sm:flex sm:items-center sm:justify-center md:mt-0 xl:w-1/3 sm:w-1/2">
                                <div className="relative flex items-center justify-center h-full px-5 pb-32 bg-logo-blue-500 xl:w-full">
                                    <img className="object-cover object-center w-full -mt-32 transition duration-200 group-hover:scale-110" src="https://cdn.tuk.dev/assets/templates/reels/building-1.png" />
                                    <div className="absolute bottom-0 left-0 flex items-center mb-12 ml-7">
                                        <hr className="w-16 bg-white border-2 border-white" />
