...
<section className="text-gray-600 body-font">
  <div className="container px-5 py-12 mx-auto lg:py-10">
    <div className="flex flex-col w-full mb-12 text-center">
      <h1 className="mb-6 text-2xl font-semibold tracking-tighter text-blue-900 sm:text-5xl title-font ">Services We Offer You</h1>
...
<div className="grid grid-cols-2 gap-4 mb-4 sm:grid-cols-3 md:grid-cols-4 md:gap-6 xl:gap-8 md:mb-8">
  {/* image - start */}
  <a href="#" className="relative flex items-end h-48 overflow-hidden bg-gray-100 rounded-lg shadow-lg group md:h-80">
