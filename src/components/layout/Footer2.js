      ...
      <div className="w-full px-4 my-4 md:w-1/3">
        ...
        <ul className="mb-6">
          ...
          <li className="flex items-center mb-2">
            ...
            <div>
              <a href="mailto:info@tailwindow.com" className="text-gray-100 hover:text-blue-300">info@tailwindow.com</a>
            </div>
          </li>
          <li className="flex items-center mb-2">
            <div className="mr-4 text-gray-100">
            ...
            <div>
              <a href="tel:+18245946369" className="text-gray-100 hover:text-blue-300">+1 8245 946 369</a>
            </div>
          </li>
        </ul>
        <a href="https://facebook.com" className="inline-flex items-center justify-center w-8 h-8 mr-3 bg-gray-200 rounded-sm hover:bg-blue-700 hover:text-gray-200 ">
