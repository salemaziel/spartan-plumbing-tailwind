...
const Footer = () => (
<footer className="text-gray-100 bg-logo-blue-500">
  <div className="container px-4 mx-auto">
    <div className="flex flex-wrap justify-between -mx-4 md:mx-32">
      <div className="w-full px-4 my-4 md:w-1/3">
        ...
        <ul className="mb-6">
          {/*<li className="flex items-center mb-2">
            ...
            {/*<div>
              <a href="http://maps.google.com" target="_blank" rel="noopener noreferrer" className="text-gray-100 hover:text-blue-300">
          ...
          <li className="flex items-center mb-2">
            ...
            <div>
              <a href="mailto:contact@spartanpad.com" className="text-gray-100 hover:text-blue-300">contact@spartanpad.com</a>
            </div>
          </li>
          <li className="flex items-center mb-2">
            <div className="mr-4 text-gray-100">
            ...
            <div>
              <a href="tel:6193249396" className="text-gray-100 hover:text-blue-300">(619) 324-9396</a>
            </div>
          </li>
        </ul>
        <a href="https://facebook.com" className="inline-flex items-center justify-center w-8 h-8 mr-3 bg-blue-700 rounded-sm hover:bg-blue-800 hover:text-gray-200 ">
          <svg className="w-4 h-4 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
            <path d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z" />
          </svg>
        </a>
        <a href="#" className="inline-flex items-center justify-center w-8 h-8 mr-3 bg-blue-700 rounded-sm hover:bg-blue-800 hover:text-gray-200 ">
          <svg className="w-4 h-4 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        ...
        {/*<a href="#" className="inline-flex items-center justify-center w-8 h-8 mr-3 bg-gray-200 rounded-sm hover:bg-blue-700 hover:text-gray-200 ">
      ...
      {/*<div className="w-full px-4 my-4 md:w-1/3">
        ...
        <ul>
          <li>
            <a href="#" className="flex mb-2 text-gray-100 hover:text-blue-300">
              ...
              <div className="ml-3 overflow-hidden">
                ...
                <span className="block text-xs text-gray-300">July 17, 2020</span>
              </div>
            </a>
          </li>
          <li>
            <a href="#" className="flex mb-2 text-gray-100 hover:text-blue-300">
              ...
              <div className="ml-3 overflow-hidden">
                ...
                <span className="block text-xs text-gray-300">June 06, 2020</span>
              </div>
            </a>
          </li>
          <li>
            <a href="#" className="flex mb-2 text-gray-100 hover:text-blue-300">
              ...
              <div className="ml-3 overflow-hidden">
                ...
                <span className="block text-xs text-gray-300">May 28, 2020</span>
              </div>
            </a>
          </li>
          <li>
            <a href="#" className="flex mb-2 text-gray-100 hover:text-blue-300">
              ...
              <div className="ml-3 overflow-hidden">
                ...
                <span className="block text-xs text-gray-300">March 15, 2020</span>
              </div>
            </a>
          </li>
          <li>
            <a href="#" className="flex mb-2 text-gray-100 hover:text-blue-300">
              ...
              <div className="ml-3 overflow-hidden">
                ...
                <span className="block text-xs text-gray-300">February 14, 2020</span>
              </div>
            </a>
          </li>
        </ul>
      ...
      <div className="w-full px-4 my-4 md:w-1/3">
        ...
        <form>
          ...
          <button className="px-4 py-2 text-gray-100 bg-gray-600 rounded-sm hover:bg-blue-700 hover:text-gray-200 focus:outline-none">Send</button>
        </form>
      </div>
    </div>
  </div>
  <div className="container px-4 mx-auto">
    <div className="flex flex-wrap items-center justify-between py-4 -mx-4">
      ...
      <p className="text-md">Spartan Plumbing &amp; Drain</p>
            ...
            <g fill="none" fillRule="evenodd">
              <g transform="translate(0 -75)">
                ...
                <text fill="white" fontFamily="Nunito-Bold, Nunito" fontSize={512} fontWeight="bold">
                  <tspan x={654} y={518}>Spartan Plumbing &amp; Drain</tspan>
