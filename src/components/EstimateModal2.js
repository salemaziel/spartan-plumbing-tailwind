...
function EstimateModal() {
    return (
        <>
            <div id="popup" className="fixed inset-0 z-50 flex justify-center w-full">
                <div onclick="popuphandler(false)" className="absolute inset-0 z-0 w-full h-full bg-gray-900" />
                <div className="container mx-auto">
                    <div className="flex items-center justify-center w-full h-full">
                        <div className="fixed w-10/12 overflow-y-auto bg-white rounded-md shadow sm:h-auto md:w-8/12 lg:w-1/2 2xl:w-2/5">
                            ...
                            <div className="px-4 pt-6 md:px-10 md:pt-12 md:pb-4 pb-7">
                                <div className="flex items-center justify-center">
                                    <div className="flex items-center justify-center w-40 h-40 p-16 bg-gray-100 rounded-md">
                                ...
                                <form className="mt-11">
                                    <div className="flex items-center space-x-9">
                                        <input placeholder="Full Name" className="w-1/2 px-3 py-3 text-sm leading-none text-gray-800 placeholder-gray-500 bg-white border border-gray-200 rounded focus:outline-none" />
                                        <input placeholder="Age" type="number" min={0} className="w-1/2 px-3 py-3 text-sm leading-none text-gray-800 placeholder-gray-500 bg-white border border-gray-200 rounded focus:outline-none" />
                                    </div>
                                    <div className="flex items-center mt-8 space-x-9">
                                        <input placeholder="Email" type="email" className="w-1/2 px-3 py-3 text-sm leading-none text-gray-800 placeholder-gray-500 bg-white border border-gray-200 rounded focus:outline-none" />
                                    ...
                                    <div className="mt-8">
                                        <textarea placeholder="Description" className="w-full h-24 py-3 pl-3 overflow-y-auto border border-gray-200 rounded resize-none focus:outline-none" defaultValue={""} />
                                    </div>
                                </form>
                                <div className="flex items-center justify-between mt-9">
                                    <button onclick="popuphandler(false)" className="px-6 py-3 text-sm text-white bg-gray-400 rounded shadow hover:bg-gray-500">
                                        Cancel
                                    </button>
                                    <button className="px-6 py-3 text-sm text-white bg-indigo-700 rounded shadow hover:bg-opacity-80">Add User</button>
                                </div>
                            </div>
                        </div>
                    </div>
