...
const EstimateForm = (props) => {
    return(
        <>
          ...
          action="/#"
          className="flex-col w-full p-6 bg-gray-100 rounded-lg md:p-8 md:mt-10 lg:w-2/6 md:w-1/2 md:flex md:ml-auto lg:mr-0 ">
            ...
            <button className="px-8 py-2 text-lg text-white bg-red-800 border-0 rounded focus:outline-none hover:bg-green-600">
              Submit
            </button>
          </form>
