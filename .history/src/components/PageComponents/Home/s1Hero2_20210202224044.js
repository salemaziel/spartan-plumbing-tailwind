      ...
      <section className="text-gray-600 body-font homeHero" style={{backgroundImage: `linear-gradient(to top, rgba(0,0,0,0.4) 0%, rgba(0,0,0,0.4) 100%), url(${props.bgImage})`, backgroundSize: "cover", backgroundRepeat: "no-repeat", backgroundPosition: "50% 50%"}}>
        <div className="container flex flex-col items-center px-5 pt-32 pb-20 mx-auto md:py-24 lg:py-32 md:flex-row md:justify-between">
         ...
         {/* <form 
          ...
          <div className="flex flex-col items-center text-center lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 lg:hidden md:items-start md:text-left">
            ...
            <div className="flex justify-center my-8 sm:my-10">
              <a href="tel:6194831212" className="inline-flex px-4 py-4 text-lg font-bold text-gray-100 bg-blue-800 border-0 rounded shadow-lg sm:px-6 focus:outline-none hover:bg-blue-600">
