  ...
  return (
    <>
      <section className="text-gray-600 body-font homeHero" style={{backgroundImage: `linear-gradient(to top, rgba(0,0,0,0.4) 0%, rgba(0,0,0,0.4) 100%), url(${props.bgImage})`, backgroundSize: "cover", backgroundRepeat: "no-repeat", backgroundPosition: "50% 50%"}}>
        <div className="container flex flex-col items-center px-5 py-20 mx-auto md:py-24 md:flex-row">
          ...
          <div className="flex-col hidden w-full p-8 mt-10 bg-gray-100 rounded-lg lg:w-2/6 md:w-1/2 md:flex md:ml-auto lg:mr-0 md:mt-0">
            <h2 className="mb-5 text-lg font-medium bg-gray-100 title-font">Sign Up</h2>
