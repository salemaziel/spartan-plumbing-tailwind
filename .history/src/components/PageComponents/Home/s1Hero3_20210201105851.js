        ...
        <div className="mb-16 lg:pr-5 lg:max-w-lg lg:mb-0">
          <div className="max-w-xl mb-6 text-center">
            ...
            <h2 className="max-w-xl mb-6 font-sans text-3xl font-bold tracking-tight text-gray-100 sm:text-4xl sm:leading-none">
              We will bring <span className="inline-block text-blue-900">your</span> <br className="hidden md:block" /> business{' '} <span className="inline-block text-blue-900"> online</span>
            </h2>
            <p className="text-base text-gray-200 md:text-lg">
            Latino Web Designers + Digital Marketers de Sur California.
          ...
          <form>
            <div className="flex flex-col md:flex-row">
              <input
                ...
                required=""
                type="text"
                className="flex-grow w-full h-12 px-4 mb-4 transition duration-200 bg-white border border-gray-300 rounded shadow-sm appearance-none md:mb-0 md:mr-2 focus:border-deep-purple-accent-400 focus:outline-none focus:shadow-outline"
              />
              <input
                placeholder="Email"
                required=""
            ...
            <div className="flex items-center mt-4">
              <button
                type="submit"
                className="inline-flex items-center justify-center h-12 px-6 mr-6 font-medium tracking-wide text-blue-100 transition duration-200 bg-white rounded shadow-md bg-deep-purple-accent-400 hover:bg-deep-purple-accent-700 focus:shadow-outline focus:outline-none"
              >
                Subscribe
              </button>
              <a
