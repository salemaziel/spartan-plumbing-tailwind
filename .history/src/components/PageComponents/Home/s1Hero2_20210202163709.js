...
const S1Hero2 = (props) => {
  return (
    <>
      <section className="text-gray-600 body-font" style={{backgroundImage: `linear-gradient(to top, rgba(0,0,0,0.4), rgba(0,0,0,0.4), url(${props.bgImage})`, backgroundSize: "cover", backgroundRepeat: "no-repeat"}}>
