...
function EstimateModal() {
  ...
  return (
    <>
      <button
        className="inline-flex px-6 py-4 ml-4 text-lg text-gray-700 whitespace-normal bg-red-800 border-0 rounded shadow-lg focus:outline-none hover:bg-gray-200"
        type="button"
