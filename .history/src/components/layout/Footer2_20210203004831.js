  ...
  <div className="container px-4 mx-auto">
    <div className="flex flex-wrap justify-between -mx-4">
      <div className="w-full px-4 my-4 md:w-1/3">
        ...
        <a href="#" className="inline-flex items-center justify-center w-8 h-8 bg-gray-200 rounded-sm hover:bg-red-700">
      ...
      <div className="w-full px-4 my-4 md:w-1/3">
        ...
        <form>
          ...
          <button className="px-4 py-2 text-gray-100 bg-gray-600 rounded-sm hover:bg-red-700 focus:outline-none">Send</button>
        </form>
      </div>
    </div>
  </div>
