...
const Footer2 = () => (
<footer className="text-gray-200 bg-blue-700">
      ...
      <div className="w-full px-4 my-4 md:w-1/3">
        ...
        <ul className="mb-6">
          <li className="flex items-center mb-2">
            ...
            <div>
              <a href="http://maps.google.com" target="_blank" rel="noopener noreferrer" className="hover:text-yellow-500">
          ...
          <li className="flex items-center mb-2">
            ...
            <div>
              <a href="mailto:info@tailwindow.com" className="hover:text-yellow-500">info@tailwindow.com</a>
            </div>
          </li>
          <li className="flex items-center mb-2">
            <div className="mr-4 text-yellow-500">
            ...
            <div>
              <a href="tel:+18245946369" className="hover:text-yellow-500">+1 8245 946 369</a>
            </div>
          </li>
        </ul>
        <a href="#" className="inline-flex items-center justify-center w-8 h-8 bg-gray-600 rounded-sm hover:bg-gray-700">
