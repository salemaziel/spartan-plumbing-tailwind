  ...
  <div className="container px-4 mx-auto">
    <div className="flex flex-wrap justify-between -mx-4">
      <div className="w-full px-4 my-4 md:w-1/3">
        ...
        <ul className="mb-6">
          <li className="flex items-center mb-2">
            ...
            <div>
              <a href="http://maps.google.com" target="_blank" rel="noopener noreferrer" className="text-gray-100 hover:text-blue-400">
          ...
          <li className="flex items-center mb-2">
            ...
            <div>
              <a href="mailto:info@tailwindow.com" className="text-gray-100 hover:text-blue-400">info@tailwindow.com</a>
            </div>
          </li>
          <li className="flex items-center mb-2">
            <div className="mr-4 text-gray-100">
            ...
            <div>
              <a href="tel:+18245946369" className="text-gray-100 hover:text-blue-400">+1 8245 946 369</a>
            </div>
          </li>
        </ul>
      ...
      <div className="w-full px-4 my-4 md:w-1/3">
        ...
        <ul>
          <li>
            <a href="#" className="flex mb-2 text-gray-100 hover:text-blue-400">
